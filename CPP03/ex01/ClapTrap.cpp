...
/*   Updated: 2023/03/22 09:12:14 by maboulho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ClapTrap::attack(const std::string& target)
{
    ...
    {
        std::cout << "ScavTrap " << this->Name<< " attacks " << target << " causing " << this->get_AttackDamage() << " points of damage" << std::endl;
        this->EnergyPoints--;
    }
    if(this->HitPoints <= 0)
...
void    ClapTrap::beRepaired(unsigned int amount)
{
    if(this->HitPoints > 0 && EnergyPoints)
    {
        std::cout << "ScavTrap " << this->Name << " repaired " << amount << " of missing health" << std::endl;
        this->EnergyPoints--;
        this->HitPoints += amount;
    }
    if(this->HitPoints <= 0)
